...
function PerformanceListEmpty({ config }: EmptyProps) {
  ...
  return (
    <Card data-testid={config.testId} className="flex h-full flex-col">
      <CardHeader className="flex flex-shrink-0 flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-sm font-medium">{config.title}</CardTitle>
        <Icon className={`h-4 w-4 ${config.iconColor}`} />
      </CardHeader>
...
export const PerformanceListWidget = memo(function PerformanceListWidget({
  ...
  return (
    <Card data-testid={variantConfig.testId} className="flex h-full flex-col">
      <CardHeader className="flex flex-shrink-0 flex-row items-center justify-between space-y-0 pb-2">
      ...
      <CardContent className="flex min-h-0 flex-1 flex-col">
        ...
        <div className="mt-3 flex-shrink-0 border-t pt-2 text-center text-xs text-muted-foreground">
