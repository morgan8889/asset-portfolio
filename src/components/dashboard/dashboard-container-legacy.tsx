...
const DashboardContainerLegacyComponent = ({
        ...
        >
          <div
            className={cn(
              ...
              gridClass,
              'items-start', // Top-align all grid items
...
export const DashboardContainerLegacy = memo(DashboardContainerLegacyComponent);
DashboardContainerLegacy.displayName = 'DashboardContainerLegacy';
