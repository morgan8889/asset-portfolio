/**
 * CSV Import Types Contract
 *
 * This file defines the type contracts for the CSV Transaction Import feature.
 * These types should be copied to src/types/csv-import.ts during implementation.
 */
